...
<header>
 ...
 <div class = "p2" align="center">
    ...
    <br>
    <br>
    <button class = "button" onclick="document.location='viewEventTypes.jsp'">View Event Types</button>
    <button class = "button" onclick="document.location='index.jsp'">Add New Event Type</button>
    <button class = "button" onclick="document.location='update.jsp'">Update an Event Type</button>
    <button class = "button" onclick="document.location='delete.jsp'">Delete an Event Type</button>
  </div>
